...
export default function Breathing() {
  return (
    <section id="breathing-feature" className="py-16 serenity-gradient relative overflow-hidden">
      ...
      {/* Particles */}
      <div
        className="particle w-3 h-3 top-[20%] left-[10%]"
        style={{ animationDelay: '0s', animationDuration: '6s' }}
      />
      <div
        className="particle w-2 h-2 top-[60%] left-[15%]"
        style={{ animationDelay: '1s', animationDuration: '8s' }}
      />
      <div
        className="particle w-4 h-4 top-[30%] right-[12%]"
        style={{ animationDelay: '2s', animationDuration: '7s' }}
      />
      <div
        className="particle w-2 h-2 top-[70%] right-[8%]"
